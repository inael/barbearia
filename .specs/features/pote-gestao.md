...
## Gaps
- **PTG-004/005 estavam PASS desde agosto apontando para `e2e/pote-gestao.spec.ts`, que NUNCA existiu.** O validador so conferia se a spec citava um nome de arquivo, nao se o arquivo existia; passou a conferir em 11/09. Nao e regressao nova: e uma afirmacao antiga sem prova, agora visivel.
