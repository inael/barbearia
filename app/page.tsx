              ...
              <tbody className="divide-y divide-neutral-100 bg-white dark:divide-neutral-800 dark:bg-neutral-950">
                {servicos.map((s) => (
                  <tr key={s.id}>
                    ...
                    <td className="px-4 py-3 text-neutral-600">{s.duracaoMin} min</td>
                    <td className="px-4 py-3">
                      {s.entraPote ? (
                        ...
                        <span className="text-xs text-neutral-600">extra</span>
                      )}
                    </td>
                  </tr>
                ))}
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {combos.map((c) => (
              ...
              >
                ...
                <p className="mt-1 text-xs text-neutral-600">{c.duracaoMin} min</p>
          ...
          <div className="flex flex-wrap gap-2">
            {profissionais.map((p) => (
              ...
              >
                ...
                <span className="ml-2 text-xs text-neutral-600">{papelLabel[p.papel] ?? p.papel}</span>
              </span>
            ))}
          </div>
        </section>

        <footer className="border-t border-neutral-200 pt-6 text-xs text-neutral-600 dark:border-neutral-800">
